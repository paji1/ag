...
const MenuItem: FC<MenuItemType> = ({ sticky }) => {
		...
		<div className="relative -mx-4 flex items-center justify-between">
			...
			<div className="flex w-full items-center justify-between px-4">
									...
									{menuItem.path ? (
										...
										<>
											<p
												...
												className={`flex cursor-pointer items-center justify-between py-2 text-base ${((theme === "light" && usePathName === "/" && !sticky) ) ? "text-white/70" : "text-dark"}  group-hover:text-primary dark:text-white/70 dark:group-hover:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6`}
											>
												{menuItem.title}
												<span className="pl-3">
				...
				<div className="flex items-center justify-end pr-16 lg:pr-0">
					<Link
						href="/signin"
						className={`hidden px-7 py-3 text-base font-medium ${((theme === "light" && usePathName === "/") ) ? "text-white" : "text-dark"}  hover:opacity-70  dark:text-white md:block`}
					>
						Sign In
					</Link>
					<Link
